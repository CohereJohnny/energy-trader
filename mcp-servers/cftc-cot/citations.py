"""
Citation metadata helpers for North MCP - CFTC COT data.
"""
...
def create_citation_metadata(
    title: str,
    source_url: str = "https://www.cftc.gov/dea/futures/petroleum_lf.htm",
    author_name: str = "CFTC - Commodity Futures Trading Commission",
    last_updated: Optional[datetime] = None,
    page_number: Optional[str] = None
) -> Dict[str, Any]:
    """
    Create citation metadata following North MCP format for CFTC COT data.
...
def format_cot_response(text: str, metadata: Dict[str, Any]) -> Dict[str, Any]:
    """
